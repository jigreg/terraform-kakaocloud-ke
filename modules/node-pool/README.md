...
| <a name="input_is_gpu"></a> [is\_gpu](#input\_is\_gpu) | Whether this is a GPU node pool. | `bool` | `false` | no |
...
| <a name="input_labels"></a> [labels](#input\_labels) | Kubernetes labels to apply to nodes. | `map(string)` | `{}` | no |
